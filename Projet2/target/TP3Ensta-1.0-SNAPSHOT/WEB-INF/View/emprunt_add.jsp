	        ...
	        <div class="row">
	          <div class="input-field col s6">
	            <select id="idLivre" name="idLivre" class="browser-default">
                  ...
                  <c:forEach items="${livres_dispo}" var="livre">
                    <option value="${livre.getPrimaryKey()}"><c:out value="${livre.getTitre()}"></c:out>, <c:out value="${livre.getAuteur()}"></c:out></option>
                  </c:forEach>
	          ...
	          <div class="input-field col s6">
	            <select id="idMembre" name="idMembre" class="browser-default">
                  ...
                  <c:forEach items="${membres_dispo}" var="membre">
                    <option value="${membre.getPrimaryKey()}"><c:out value="${membre.getPrenom()}"></c:out>, <c:out value="${membre.getNom()}"></c:out></option>
                  </c:forEach>
