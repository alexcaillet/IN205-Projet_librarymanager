	          ...
	          <table class="striped no-padding">
                ...
                <tbody>
                  <c:forEach items="${livres}" var="livre">
                    <tr>
                      <td><c:out value="${livre.getTitre()}"></c:out></td>
                      <td><c:out value="${livre.getAuteur()}"></c:out></td>
                      <td><c:out value="${livre.getISBN()}"></c:out></td>
                      <td class="center"><a href="livre_details?id=${livre.getPrimaryKey()}"><ion-icon class="details" name="information-circle-outline"></ion-icon></a></td>
                    </tr>
                  </c:forEach>
                    <!--<tr>
